...
Very lean (148MB) and highly configurable Elasticsearch Docker image.
...
docker run --name elasticsearch \
	...
	--volume /path/to/data_folder:/data \
        quay.io/pires/docker-elasticsearch:5.0.1
```
...
* [CLUSTER_NAME](https://www.elastic.co/guide/en/elasticsearch/reference/5.1/important-settings.html#cluster.name)
